...
class QuestionItemSchema(BaseModel):
    ...
    correct_answer: str = Field(description="Identifier of the correct option, e.g., 'A'")
    explanation: str = Field(description="Concise justification for why this answer is correct")
